    ...
    <div class='card border-dark'>
        ...
        <form action='' method='post' style="margin: 20px;">
            <div class="input-group mb-3">
                ...
                <input type='text' class='form-control' name='userid' autocomplete='off' <?php echo "value='{$currentuser->user_id}'"; ?>
                       readonly>
            </div>
            <div class="input-group mb-3">
                <span class='input-group-text' id='email'>邮箱</span>
                <input type='email' class='form-control' name='email'autocomplete='off'  <?php echo "value='{$currentuser->email}'"; ?>
                       required>
            </div>
            <div class="input-group mb-3">
