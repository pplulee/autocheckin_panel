    ...
    <div class='card border-dark'>
        ...
        <form action='' method='post' style="margin: 20px;">
            <div class="input-group mb-3">
                ...
                <input type='text' class='form-control' name='user_id' <?php echo "value='{$currentuser->user_id}'"; ?> >
            </div>
            <div class="input-group mb-3">
                <span class='input-group-text' id='email'>邮箱</span>
                    <input type='email' class='form-control' name='email' <?php echo "value='{$currentuser->email}'"; ?> required>
            </div>
            <div class="input-group mb-3">
