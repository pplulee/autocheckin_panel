        ...
        <form action='' method='post' style="margin: 20px;">
            <div class="row">
                <div class="input-group mb-3">
                    ...
                    <input type='text' required class='form-control' name='username' value='<?php echo $currenttask->username; ?>'>
                </div>
            </div>
            <div class="row">
                <div class="input-group mb-3">
                    <span class='input-group-text' id='name'>密码</span>
                    <input type='text' required class='form-control' name='password' value='<?php echo $currenttask->password; ?>'>
                </div>
            </div>
            <div class="row">
                <div class="input-group mb-3">
